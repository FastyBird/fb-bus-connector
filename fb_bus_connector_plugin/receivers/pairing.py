...
class PairingReceiver(BaseReceiver):  # pylint: disable=too-few-public-methods
    ...
    def __receive_pairing_finished(self, entity: PairingFinishedEntity) -> None:
        ...
        device_record = self.__devices_registry.create(
            ...
            pub_sub_pub_support=self.__device_pairing.pairing_device.pub_sub_pub_support,
            pub_sub_sub_support=self.__device_pairing.pairing_device.pub_sub_sub_support,
            pub_sub_sub_max_subscriptions=self.__device_pairing.pairing_device.pub_sub_max_subscriptions,
            pub_sub_sub_max_conditions=self.__device_pairing.pairing_device.pub_sub_max_subscription_conditions,
            pub_sub_sub_max_actions=self.__device_pairing.pairing_device.pub_sub_max_subscription_actions,
